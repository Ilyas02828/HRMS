...
Route::controller(EmployeeController::class)->group(function () {
    ...
    Route::delete('all/employee/delete/{employee_id}', 'deleteRecord')->middleware('auth')->name('all/employee/delete');
    ...
    Route::get('department/deptemployees/{id}', 'deptemployees')->middleware('auth')->name('department/deptemployees');

    Route::get('form/hourly-rate/page', 'RecordHourlyRate')->middleware('auth')->name('form/hourly-rate/page');
    Route::post('form/hourly-rate/save', 'saveRecordHourlyRate')->middleware('auth')->name('form/hourly-rate/save');
    Route::post('form/hourly-rate/update', 'updateRecordHourlyRate')->middleware('auth')->name('form/hourly-rate/update');
    Route::post('form/hourly-rate/delete', 'deleteRecordHourlyRate')->middleware('auth')->name('form/hourly-rate/delete');
...
Route::controller(MonthlySalaryController::class)->group(function () {
    ...
    Route::get('fetch-hourly-rates', 'fetch_hourly_rates')->middleware('auth')->name('fetch-hourly-rates');
    Route::get('fetch-hourly-rate', 'fetch_hourly_rate')->middleware('auth')->name('fetch-hourly-rate');
    Route::get('monthly-salary/detail/{id}', 'detail')->middleware('auth')->name('monthly-salary/detail');
...
Route::controller(ExpenseReportsController::class)->group(function () {
    Route::get('expense/project-expense/index', 'index')->middleware('auth')->name('expense/project-expense/index');
...
Route::controller(TimeSheetController::class)->group(function () {
    ...
    // -------------------- estimate  -------------------//
    Route::get('punch', 'punch')->middleware('auth')->name('punch');
    Route::post('punchin/save', 'punchin')->middleware('auth')->name('punchin/save');
    Route::post('punch/delete', 'delete')->middleware('auth')->name('punch/delete');
    Route::get('punchin/import', 'import')->middleware('auth')->name('punchin/import');
    Route::get('download_template', 'download_template')->name('download_template');
    Route::post('importcsv', 'importcsv')->name('importcsv');
    Route::get('timesheetreports', 'timesheetReports')->middleware('auth')->name('timesheetreports');
