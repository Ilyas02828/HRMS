                            ...
                            @endphp
                                @foreach ($empList as $key=>$employee )
                                        <tr >
                                            ...
                                            <td class="employee_employee_id">{{ $employee->employee_id }}</td>
                                            ...
                                            @endphp
                                            <td class="employee_ecoma_expiry" style="{{$style}}">{{ $employee->ecoma_expiry }}</td>
                                            ...
                                            <td class="text-right">
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <a class="dropdown-item delete_employee" href="{{ url('all/employee/delete', $employee->id) }}" class="btn btn-danger" data-confirm-delete="true"> <i class="fa fa-trash-o m-r-5"></i>Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="ecoma_number" name="ecoma_number" placeholder="Iqama Number">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="col-form-label">Iqama Type <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" id="ecoma_type" name="ecoma_type" placeholder="Iqama Type">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="col-form-label"> Iqama Expiry <span class="text-danger">*</span></label>
                                        <input class="form-control datetimepicker" type="text" id="ecoma_expiry" name="ecoma_expiry" placeholder="Iqama Expiry">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
