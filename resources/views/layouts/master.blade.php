		...
		<div class="header">
			...
			<div class="header-left">
				<a href="{{ route('home') }}" class="logo">
					<img src="{{ URL::to('/assets/images/'. Auth::user()->avatar) }}" width="90" height="60" style="margin-right: 60px;" alt="">
				</a>
			</div>
			<!-- /Logo -->
			...
			<ul class="nav user-menu">
				...
				<li class="nav-item dropdown has-arrow main-drop">
					<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
						...
						<img src="{{ URL::to('/assets/images/'. Auth::user()->avatar) }}"  style="width: 63px;
    height: auto;" alt="{{ Auth::user()->name }}">
